...
namespace JoyKeys.Voluntary
{
    ...
    {
        public JoystickButtons buttons = JoystickButtons.None;
        /// <summary>
        /// 根据游戏手柄的Id实例化
        /// </summary>
        ...
        /// 前一次的处于按下状态的按钮
        /// </summary>
        public JoystickButtons PreviousButtons = JoystickButtons.None;
        public JoystickAPI.JOYINFOEX infoEx;
        /// <summary>
        /// 定时器的回调方法
        /// </summary>
        ...
        private void OnTimerCallback(object state)
        {
            ...
            {
                buttons = GetButtons(infoEx.dwButtons);
